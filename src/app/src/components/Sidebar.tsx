import { Avatar, Container, Flex, Heading, Icon, Link, Text } from '@chakra-ui/react';
// @ts-ignore
import jtw from '../media/jtw.png';
    ...
    return (
        <Container maxW='xs' height='100%' bgColor='brand.500' bgGradient='linear(to-r, brand.500, teal.100)' ml={0}>
            <Flex direction='column' alignItems='center' pl={0} mb={4} minHeight='100vh'>
                ...
                <Link mt={4} href='https://www.github.com/jacobtylerwalls' aria-label='GitHub profile'>
